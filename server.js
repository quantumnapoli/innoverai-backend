...
app.use((req, res, next) => {
    ...
    const extraConnect = process.env.CSP_CONNECT_SRC || "https://innoverai-production-06cb.up.railway.app https://innoverai-backend-production.up.railway.app https://dashboard.innoverai.com";
